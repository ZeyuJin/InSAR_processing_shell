...
#
  ...
  foreach line (`awk '{print $0}' $1`)
    ...
    echo $pth"tmp.PRM:"$pth"topo_filt.grd" >> tmp_topolist
  ...
  echo "first.PRM:first_topo.grd" > second_topo.txt
  tail -1 tmp_topolist >> second_topo.txt  
  ...
  merge_swath second_topo.txt topo_filt.grd
