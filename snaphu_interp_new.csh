...
# Using griddata function in MATLAB to nearest interpolate the phase
# instead of nearest_grid to faster the speed
...
run_phase_interp_ra_new.sh $MATLAB   # use griddata instead of nearest_grid to reduce computing time
gmt grdedit tmp.grd -T
...
# clean up
#
mv -f phase_tmp.grd phasefilt_interp.grd
rm -f tmp.grd corr_tmp.grd unwrap.out tmp2.grd unwrap_grad.grd # phase_tmp.grd
rm -f phase.in corr.in 
# mv -f phase_patch.grd phasefilt_interp.grd   # not real interpolated data
#
#   cleanup more
#
